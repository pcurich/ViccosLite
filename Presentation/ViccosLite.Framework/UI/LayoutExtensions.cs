...
namespace ViccosLite.Framework.UI
{
    public static class LayoutExtensions
    {
        ...
        public static MvcHtmlString SoftTitle(this HtmlHelper html, bool addDefaultTitle, string part = "")
        {
            var pageHeadBuilder = EngineContext.Current.Resolve<IPageHeadBuilder>();
        ...
        public static MvcHtmlString SoftMetaDescription(this HtmlHelper html, string part = "")
        {
            var pageHeadBuilder = EngineContext.Current.Resolve<IPageHeadBuilder>();
        ...
        public static MvcHtmlString SoftMetaKeywords(this HtmlHelper html, string part = "")
        {
            var pageHeadBuilder = EngineContext.Current.Resolve<IPageHeadBuilder>();
        ...
        public static MvcHtmlString SoftScripts(this HtmlHelper html, UrlHelper urlHelper,
        ...
        public static MvcHtmlString SoftCssFiles(this HtmlHelper html, UrlHelper urlHelper, ResourceLocation location,
        ...
        public static MvcHtmlString SoftCanonicalUrls(this HtmlHelper html, string part = "")
        {
            var pageHeadBuilder = EngineContext.Current.Resolve<IPageHeadBuilder>();
        ...
        public static MvcHtmlString SoftHeadCustom(this HtmlHelper html)
        {
            var pageHeadBuilder = EngineContext.Current.Resolve<IPageHeadBuilder>();
